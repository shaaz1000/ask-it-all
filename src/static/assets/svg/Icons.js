import AssetLogo from "./ASK-IT-ALL.svg";
import IconBooking from "./icons/Bookings.svg";
...
// ICONS
export const ICON_BOOKING = IconBooking;
export const ICON_HISTORY = IconHistory;
export const ICON_PAYMENT = IconPayment;
